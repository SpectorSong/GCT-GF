...
class ContextualAttention(nn.Module):
    def __init__(self, ksize=3, stride=1, rate=1, fuse_k=3, softmax_scale=10., fuse=True, use_cuda=False):
    ...
    def forward(self, f, b, mask=None):
        ...
        # m shape: [N, C*k*k, L]
        m = extract_image_patches(mask.float(), ksizes=[self.ksize, self.ksize], strides=[self.stride, self.stride],
